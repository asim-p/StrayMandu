...
const styles = StyleSheet.create({
  ...
  onlineBadge: { position: 'absolute', bottom: 0, right: 0, width: 12, height: 12, backgroundColor: COLORS.primary, borderRadius: 6, borderWidth: 2, borderColor: '#FFF' },
  greetingText: { fontSize: 12, color: COLORS.textSub, fontWeight: '500' },
  userName: { fontSize: 18, color: COLORS.textMain, fontWeight: '700', lineHeight: 22 },
  iconButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: COLORS.backgroundLight, justifyContent: 'center', alignItems: 'center' },
  sectionContainer: { paddingHorizontal: 16, marginTop: 16 },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  sectionTitle: { fontSize: 20, fontWeight: '700', color: COLORS.textMain, letterSpacing: -0.5 },
  viewAllBtn: { flexDirection: 'row', alignItems: 'center' },
  viewAllText: { fontSize: 14, color: COLORS.primary, fontWeight: '700' },
  heroCard: { height: 240, borderRadius: 24, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.1, shadowRadius: 15, elevation: 8 },
  heroImage: { width: '100%', height: '100%' },
  heroOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.3)', justifyContent: 'flex-end', padding: 20 },
  heroContent: { gap: 4 },
  emergencyBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20, alignSelf: 'flex-start', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', marginBottom: 8, gap: 4 },
  emergencyText: { color: '#FFF', fontSize: 12, fontWeight: '700' },
  heroTitle: { fontSize: 24, fontWeight: '800', color: '#FFF', letterSpacing: -0.5 },
  heroSubtitle: { fontSize: 14, color: 'rgba(255,255,255,0.9)', fontWeight: '500', marginBottom: 16 },
  heroButton: { height: 48, backgroundColor: COLORS.primary, borderRadius: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.5, shadowRadius: 10, elevation: 5 },
  heroButtonText: { fontSize: 16, fontWeight: '700', color: '#121811' },
  mapCard: { borderRadius: 16, overflow: 'hidden', borderWidth: 1, borderColor: '#E5E7EB', height: 180 },
  mapImage: { flex: 1 },
  mapOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.05)' },
  mapPinContainer: { position: 'absolute', top: '30%', left: '25%' },
  mapPin: { width: 32, height: 32, borderRadius: 16, backgroundColor: COLORS.primary, borderWidth: 2, borderColor: '#FFF', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, elevation: 4 },
  mapInfoCard: { position: 'absolute', bottom: 12, left: 12, right: 12, backgroundColor: 'rgba(255,255,255,0.95)', borderRadius: 12, padding: 12, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, elevation: 2 },
  ...
  mapInfoSub: { fontSize: 10, color: '#6B7280', fontWeight: '600' },
  ...
  listCard: { width: 240, backgroundColor: '#FFF', borderRadius: 16, overflow: 'hidden', marginRight: 16, borderWidth: 1, borderColor: '#F3F4F6', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, elevation: 2 },
  listCardImage: { height: 128, width: '100%' },
  cardBadge: { position: 'absolute', top: 8, left: 8, color: '#FFF', fontSize: 10, fontWeight: '700', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12, textTransform: 'uppercase' },
  listCardContent: { padding: 12 },
  listCardTitle: { fontSize: 16, fontWeight: '700', color: COLORS.textMain, marginBottom: 4 },
  listCardDesc: { fontSize: 12, color: '#6B7280', marginBottom: 12, lineHeight: 16, height: 32 },
  actionButtonOutline: { backgroundColor: 'rgba(55,236,19,0.1)', paddingVertical: 8, borderRadius: 8, alignItems: 'center' },
  actionButtonText: { fontSize: 12, fontWeight: '700', color: COLORS.textMain },
});