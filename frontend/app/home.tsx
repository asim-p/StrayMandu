      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={styles.userName}>Namaste, {userName ?? 'Aarav'} 👋</Text>
          </View>
        </View>
        <Pressable 
              ...
              <View style={styles.mapInfoCard}>
                <View style={styles.mapInfoLeft}>
                  ...
                  <View>
                    ...
                    <Text style={styles.mapInfoSub}>Thamel, Kathmandu</Text>
                  </View>
                </View>
      ...
      <View style={styles.bottomNavContainer}>
        <View style={styles.bottomNav}>
          <Pressable onPress={() => router.push('/')} style={styles.navItem}>
            ...
            <Text style={[styles.navLabel, { color: COLORS.textMain, fontWeight: '700' }]}>Home</Text>
          </Pressable>

          <Pressable onPress={() => router.push('/map')} style={styles.navItem}>
            <MaterialIcons name="map" size={26} color="#9CA3AF" />
...
const styles = StyleSheet.create({
  ...
  heroOverlay: {
    flex: 1,
    backgroundColor: 'rgba(0,0,0,0.3)', // Simulating gradient
  ...
  mapCard: {
    ...
    borderWidth: 1,
    borderColor: '#E5E7EB',
    height: 180, // Aspect 2:1 approx for width
  },
  mapImage: {
    flex: 1,
  },
  ...
  bottomNav: {
    ...
    paddingHorizontal: 16,
    height: 80, // Taller to accommodate text
    paddingBottom: 10,
  },
  navItem: {
    alignItems: 'center',
  ...
  floatingButton: {
    ...
    alignItems: 'center',
    borderWidth: 4,
    borderColor: COLORS.backgroundLight, // Match bg color to look "cut out"
    shadowColor: COLORS.primary,
